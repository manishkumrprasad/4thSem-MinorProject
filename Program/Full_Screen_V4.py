...
frameOne = tk.Frame(window , bg="#DBDBDB" , width=1280,height=170)
...
menuFrame = tk.Frame(frameOne , height=30 , width=1280 , bg="red")
...
# ToolLabel
toolLabel = tk.Label(toolFrame , text="Tool Bar" , width=25 , bg="#DBDBDB")
