...
window.title("Painting Window Version 4")
...
iconOfPencil = tk.PhotoImage(file="4thSem-MinorProject/Icons/Small_Pencil.png")
iconOfEraser = tk.PhotoImage(file="4thSem-MinorProject/Icons/Small_Eraser.png")
iconOfFont = tk.PhotoImage(file="4thSem-MinorProject/Icons/Small_Font.png")
iconOfGlass = tk.PhotoImage(file="4thSem-MinorProject/Icons/Small_Glass.png")
iconOfFill = tk.PhotoImage(file="4thSem-MinorProject/Icons/Small_Fill.png")
...
toolFrame = tk.Frame(frameOne , height=100 , width=120 , bg="#D6F5EF")
